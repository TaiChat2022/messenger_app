        ...
        <>
            {windowWidth < 500 ? (
                <>
                    ...
                    >
                        <div className="absolute inset-y-4 inset-x-1/4 z-50 w-full p-4 h-[calc(100%-2rem)] max-h-full">
                                ...
                                <div className="relative custom_bg_color__100 rounded-lg shadow border">
                                    <div className='modal_height'>
                                        <div className="grid grid-cols-2 h-full mb-4">
                                            ...
                                            {/* option right */}
                                            <div className="flex-auto items-start justify-start h-24 custom_text_color__100 overflow-x-hidden overflow-y-auto h-full rounded-lg">
