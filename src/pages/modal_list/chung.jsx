...
const Chung = ({
    ...
    return (
        <>
            <button type="button" className="custom_text_color__400 px-3 mb-1 bg-transparent hover_close_modal text-sm w-8 h-8 ml-auto flex justify-end items-center" onClick={handleCloseModal}>
