...
const Menu = ({
    ...
    return (
        <>
                        ...
                        <div className='container'>
                            <button id="doubleDropdownButton" data-dropdown-toggle="doubleDropdown" data-dropdown-placement="right-start" type="button"
                                className="flex items-center justify-evenly w-full">
                                {
                                    ...
                                    (
                                        <>
                                            <img className="w-10 h-10 rounded-full border-solid border-2 border-black" src={user.photoURL} alt="user photo" />
                                        </>
                                    )
                                }
                            </button>
                            <div id="doubleDropdown" className="z-15 hidden custom_bg_color__400 rounded-lg shadow w-44 dark:bg-gray-700">
                                <ul className="py-1 text-sm shadow-lg custom_text_color__300 divide-y divide-gray-500" aria-labelledby="doubleDropdownButton">
                                    <li>
                                        <a data-modal-target="tuyChon_Modal" data-modal-toggle="tuyChon_Modal" className="flex items-center justify-around cursor-pointer px-4 py-3">
            ...
            <div id="tuyChon_Modal" tabIndex={-1} aria-hidden="true" className="fixed top-16 left-0 right-0 z-50 hidden w-full p-4  md:inset-0  h-[calc(100%-2rem)] max-h-full">
                <div className="relative w-full max-w-2xl max-h-full h-screen">
                    <div className="relative custom_bg_color__100 rounded-lg shadow">

                        <div className='modal_height'>
                            <div className="grid grid-cols-2 h-full mb-4">
                                {/* option left */}
                                <div className="flex items-start col-span-1 justify-start border-r border-gray-900 overflow-x-hidden overflow-y-auto">
                                    <div class="flex flex-col h-full relative w-full custom_bg_color__100 custom_text_color__100 overflow-auto mr-1 ">
                                        {/* List tùy chọn */}
                                        ...
                                        <div className={`flex items-center gap-4 p-4 cursor-pointer ${currentModal === 'show_trangThai' ? 'custom_bg_color__200' : ''} `}
                                            ...
                                            <div className='bg-green-400 text-white w-10 h-10 p-2 rounded-full '>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-incognito" viewBox="0 0 16 16">
                                ...
                                {/* option right */}
                                <div className="flex-auto items-start justify-start h-24 custom_text_color__100 overflow-x-hidden overflow-y-auto h-full">
